...
public class ViewDictionary extends JPanel{
	...
	protected	JTextField	graph,vertex,edge,vertexValue,edgeValue;
	protected	JTextField	graph1,vertex1,edge1,vertexValue1,edgeValue1;
	...
	private void initElements() {
		...
		gbc.gridy = 3; add(new JLabel("Edge"), gbc);
		gbc.gridy = 4; add(new JLabel("Edge value"), gbc);
		gbc.gridy = 5; add(save, gbc);
		...
		gbc.gridy = 3; add(edge, gbc);
		gbc.gridy = 4; add(edgeValue, gbc);
		gbc.gridy = 5; add(reset, gbc);
		...
		gbc.gridy = 2; add(vertexValue1, gbc);
		gbc.gridy = 3; add(edge1, gbc);
		gbc.gridy = 4; add(edgeValue1, gbc);
